        ...
        \section[Adventist Intercollegiate Association]
            ...
            \subsection[Delegate Selection]
                ...
                \paragraph In order to properly represent the entire ASWWU student government, delegates to the AIA convention must be selected to represent each of the following ASWWU branches:
                    \subparagraph[Executive:] Outgoing and incoming Presidents
                    \subparagraph[Legislative:] Outgoing and incoming Executive Vice Presidents
                    \subparagraph[Social:] Outgoing and incoming Social Vice Presidents
                    \subparagraph[Spiritual:] Outgoing and incoming Spiritual Vice Presidents
...
\title[Governance]
    ...
    \article[Executive Cabinet]
        \section[Membership]
            ...
            \subsection The Executive Cabinet shall be as follows: President, ASWWU Chief of Staff, Executive Vice President (EVP), Social Vice President (SOVP), Spiritual Vice President (SIVP), Financial Vice President (FVP), Marketing Vice President (MVP), Diversity and Wellness Officer, and the Portland ASWWU President.
        ...
        \section[Appointed Positions]
            ...
            \subsection[Appointment of the Atlas Manager]
                \paragraph Applications for the position of Atlas Manager are due the second Wednesday following the General Election.
                \paragraph The incoming President, the outgoing President, and current Atlas Manager shall review the applications, contact references, interview each of the candidates separately, and vote on an applicant.
    ...
    \article[Committees and Boards]
        ...
        \section[Sustainability Committee]
            \subsection The Sustainability Committee will prioritize a commitment to sustainability and environmental responsibility on the WWU campus.
            \subsection This committee will meet monthly and be chaired by any nominated member of ASWWU.
            \subsection This committee will consist of a minimum of three nominated members of ASWWU, including the chair.
            \subsection This committee will pursue ways to improve recycling and waste management, reduce the WWU footprint, raise campus and community awareness, and find support and funding for these improvements on campus, local, and higher levels.
            \subsection Nomination and approval of committee membership will be completed by the ASWWU President, Senate, and WWU Nominating Committee as detailed in Section 2.5.1
...
\title[Financial Control]
    ...
    \article[Reserve Structure and Control]
        ...
        \section[Long-Term Projects Fund]
            ...
            \subsection Proposals made to the LTPC will be made publicly available and posted on ASWWU.com. Additionally, it will be announced in \textit[The Collegian] and in the weekly ASWWU Marketing email whenever the LTPC hears a proposal. This announcement shall include the name of the lead proposer as well as the title of their proposal and a description not exceeding 120 characters in length.
        ...
        \section[Investment of Excess Funds]
            \subsection Excess funds available at the close of any given year’s budget on June 30 of that year, after the Long-Term Projects Fund balance and Capital Reserve balance have been updated according to 2.1 and 4.3 of this Article, shall be referred to as net income. Any net income at year-end will be invested in the Long-Term Projects Fund to grow the principal balance of the Long-Term Projects Fund.
